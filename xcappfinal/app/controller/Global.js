...
Ext.define('jxxc.controller.Global', {
    ...
    config: {
        ...
        refs: [
            ...
            {
                ref: 'mainView',
                selector: 'jz-mainview'
            },
            {
                ref: 'realtimeView',
                selector: 'jz-realtimeview'
            },
            {
                ref: 'historyView',
                selector: 'jz-historyview'
            },
            {
                ref: 'routeView',
                selector: 'jz-routeview'
            },
            {
                ref: 'rtmView',
                selector: 'jz-rtmview'
        ...
        control: {
            ...
            'jz-realtimeview': {
                added: function (view, container, pos, eOpts) {
                    var rtGrid = view.down('gridpanel');
                    var rtData = rtGrid.getStore();
                    if (mv.v.map) {
                        //mv.fn.loadRealTimeRoute(rtData.data.items);
                    }
                }
            },
            'jz-historyview': {
